...
while swarmSize<=100
    while maxIt<=400000
        ...
        while it<=maxtrials
            ...
            %array to hold best cost value to each iteration
            ...
            while t<=maxIt
                ...
                %% Adjustment Part
                w=0.5+(1/(2*(log(t)+1))); %Montalvo Method
            ...
            %% End Main Loop
                ...
                if mod(t,30000)==0
                    num=it;
                    filename=sprintf('%s_%d_%d_%d.mat','MPSOCO_f2_schwefel222fcn_Montalvo',num,maxIt,swarmSize);
                    save(filename);
                end
            end
